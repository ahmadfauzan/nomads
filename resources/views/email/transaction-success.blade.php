...
<body style="word-spacing:normal;background-color:#E4E6ED;">
  <div style="background-color:#E4E6ED;">
                          ...
                          <tbody>
                            <tr>
                              <td style="width:550px;">
                                <img alt="" height="auto" src="{{ url('storage/' . $data->travel_package->galleries[1]->image) }}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="550" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                          ...
                          <tbody>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                <div style="font-family:Assistant, Helvetica, Arial, Sans-Serif;font-size:18px;line-height:20px;text-align:left;color:#071C4D;">Hi, {{ $data->user->name }} <br>
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:0px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:1;text-align:center;color:#6F7074;">2019 Nomads Copyright All Rights Reserved.</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
